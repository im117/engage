...
// const ProfileFollow: React.FC<ProfileFollowProps> = ({ targetUsername, loggedIn }) => {
...
//         try {
//             const response = await axios.get(`${loginServer}/get-user-id`, {
//             params: { username: targetUsername },
//             });
//             setTargetUserId(response.data.userId); // Set the target user ID
//         } catch (error) {
...
//     fetchIsSelfStatus();
//     fetchFollowStatus();
//   }, [targetUsername, loggedIn]); // Added targetUser and loggedIn as dependencies
